...
public class FrameGui implements ActionListener {
    ...
    static public GridBagConstraints GuessDisplayPanelGBC = new GridBagConstraints();
    static public JPanel RemainingLettersPanel = new JPanel();
    static public JPanel ResultPanel = new JPanel();
    public static JButton PlaceHolder = new JButton("");
    static public int width = Toolkit.getDefaultToolkit().getScreenSize().width;
    static public int height = Toolkit.getDefaultToolkit().getScreenSize().height;
    ...
    static public final Color FRAME_COLOR = new Color(33, 33, 33);
    static public final Color DEFAULT_HOME_BUTTON_COLOR = new Color(200, 200, 200);
    static public final Color BACK_BUTTON_COLOR = new Color(255, 220, 125);
    static public final Color GUESS_PANEL_COLOR = new Color(15, 15, 15);
    static public final Color REMAINING_LETTERS_PANEL_COLOR = new Color(15, 15, 15);
    static public final Color DEFAULT_GUESS_COLOR = new Color(200, 200, 200);
    static public final Color CURRENT_GUESS_COLOR = new Color(191, 220, 220);
    static public final Color DEFAULT_REMAINING_LETTER_COLOR = new Color(190, 190, 190);
    static public final Color STATS_BUTTON_COLOR = new Color(242, 189, 133);
    static public final Color GREEN_COLOR = new Color(139, 188, 152);
    static public final Color YELLOW_COLOR = new Color(231, 231, 150);
    static public final Color RED_COLOR = new Color(255, 142, 142);
    
    static public final int DEFAULT = 0;
    static public final int CURRENT = 1;
    static public final int GREEN = 2;
    static public final int YELLOW = 3;
    static public final int RED = 4;
    
    static public final int ERROR = -1;
    static public final int DAILY_MODE = 0;
    static public final int PRACTICE_MODE = 1;
    static public final int NEW_GAME = 2;
    static public int gameMode = 0;

    static public JPanel StatDisplayPanel = new JPanel(new GridBagLayout());
    static public JScrollPane StatDisplayScroll = new JScrollPane(StatDisplayPanel);
    static public StatDisplay DailyStatDisplay;
    static public StatDisplay PracticeStatDisplay;

    static public JPanel HelpDisplayPanel = new JPanel(new GridBagLayout());
    static public JScrollPane HelpDisplayScroll = new JScrollPane(HelpDisplayPanel);
    ...
    public void start() {
        ...
        newRemainingLetters();
        GuessDisplayPanel.setVisible(false);
        GuessDisplayPanel.setLayout(new GridBagLayout());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (ButtonClicked == Daily) {
            ...
            StatDisplay.setScrollPosition(0);
        }
    ...
    public void updateScreen() {
        ...
        StatDisplay.updateScreen();
    }
    
    
    public void newGuessDisplay() {
        GuessDisplayPanelGBC.insets = new Insets(3,1,0,0);
        for (int r = 0; r < GuessDisplays.length; r++) {
            for (int c = 0; c < GuessDisplays[currentRow].length; c++) {
                GuessDisplayPanelGBC.gridx = c;
                GuessDisplayPanelGBC.gridy = r;
    ...
    public static void defaultRowGuessDisplayColor() {
        for (int c = 0; c < GuessDisplays[currentRow].length; c++)
            GuessDisplays[currentRow][c].updateDisplayColor(DEFAULT_GUESS_COLOR);
    }
